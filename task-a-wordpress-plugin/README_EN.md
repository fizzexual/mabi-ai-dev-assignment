...
1. Copy the `task-a-wordpress-plugin` folder into `wp-content/plugins/mabi-member-api/` (or place `mabi-member-api.php` directly into `wp-content/mu-plugins/` for auto-activation).
